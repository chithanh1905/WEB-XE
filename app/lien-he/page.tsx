    ...
    <>
      <div style={{ background: "linear-gradient(135deg, var(--vf-blue-dark), var(--vf-blue))" }} className="py-12 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-sm text-white/70 mb-2">Trang chủ / Liên hệ</div>
          <h1 className="text-3xl md:text-4xl font-black mb-2">Liên hệ & Đặt lịch lái thử</h1>
          <p className="text-white/80">Đội ngũ tư vấn của chúng tôi luôn sẵn sàng hỗ trợ bạn 7 ngày trong tuần</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              {[
                ...
                {
                  icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="#005BAC"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>,
                  title: "Tổng đài VinFast",
                  content: DEALER_INFO.phone,
                  link: DEALER_INFO.phoneLink,
                },
                {
                  icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="#005BAC"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>,
                  title: "Email",
                  content: DEALER_INFO.email,
                  link: `mailto:${DEALER_INFO.email}`,
                },
                {
              ...
              <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                <p className="text-xs text-gray-500 font-semibold uppercase tracking-wide mb-3">Mạng xã hội</p>
